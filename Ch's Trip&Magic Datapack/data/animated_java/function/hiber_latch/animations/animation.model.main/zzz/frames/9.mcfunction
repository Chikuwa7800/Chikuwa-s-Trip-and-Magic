...
$data merge entity $(bone_bone19) {transformation: [-1.2182f,-1.8141f,1.6696f,-0.875f,-0.6961f,2.0396f,1.7082f,-0.0625f,-2.3652f,0.3341f,-1.3627f,1f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
$data merge entity $(bone_bone7) {transformation: [-2.6848f,-0.2515f,-0.5394f,0.1875f,0f,2.4923f,-1.1622f,0.1875f,0.5952f,-1.1347f,-2.4333f,-0.5625f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
