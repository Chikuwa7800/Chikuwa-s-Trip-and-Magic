...
execute positioned ~-2.5 ~ ~-2.5 as @e[tag=!ch_tm_magic_pl_freeze,dx=5,dy=4,dz=5,type=!#ch_trip_and_magic:cannot_hurt_entities] at @s positioned ~2.5 ~ ~2.5 run damage @s 10 ch_trip_and_magic:magic/ice_lv2_break by @e[tag=ch_tm_magic_pl_freeze,sort=nearest,limit=1]
