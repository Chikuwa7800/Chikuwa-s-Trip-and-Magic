...
$summon block_display ~ ~ ~ {teleport_duration:3,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.2f,0.2f,0.2f]},Tags:["ls_tm_wind_display","ls_tm_magic_ball"],Passengers:[{id:"minecraft:area_effect_cloud",Owner:$(UUID),custom_particle:{type:"enchant"},Radius:0.5f,Tags:["ch_tm.magic_info"]}]}
