##ティック処理
 ...
 #埋まり対策
  execute as @e[tag=ch_tm_bosses_boss] at @s unless block ~ ~ ~ #ch_trip_and_magic:no_collision if block ~ ~1 ~ #ch_trip_and_magic:no_collision run tp @s ~ ~1 ~
  execute as @e[tag=ch_tm_bosses_boss] at @s if block ~ ~ ~ #ch_trip_and_magic:no_collision unless block ~ ~1 ~ #ch_trip_and_magic:no_collision run tp @s ~ ~1 ~
  execute as @e[tag=ch_tm_bosses_boss] at @s unless block ~ ~ ~ #ch_trip_and_magic:no_collision unless block ~ ~1 ~ #ch_trip_and_magic:no_collision run tp @s ~ ~1 ~
