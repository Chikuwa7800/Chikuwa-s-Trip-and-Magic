...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @n[tag=!ch_trip_and_magic_bosses_intaract_ginga,type=!#ls_trip_and_magic:mobs,tag=!ch_tm_bosses_cutter,dx=0] at @s positioned ~0.5 ~0.5 ~0.5 run damage @s 7 ls_trip_and_magic:entity/ginunga/cut_attack_projectile by @n[tag=ch_tm_bosses_cutter] from @n[tag=ch_trip_and_magic_bosses_intaract_ginga]
