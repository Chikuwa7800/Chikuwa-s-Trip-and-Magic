...
execute if score @s ch_tm_bosses_explotion_tick matches 1..45 at @e[tag=ch_tm_bosses_ginga_explotion_before_2] run playsound block.note_block.chime player @a[distance=..5,limit=1,sort=nearest] ~ ~ ~ 1 2
execute if score @s ch_tm_bosses_explotion_tick matches 1..45 at @e[tag=ch_tm_bosses_ginga_explotion_before_2] run playsound block.note_block.harp player @a[distance=..5,limit=1,sort=nearest] ~ ~ ~ 1 2
