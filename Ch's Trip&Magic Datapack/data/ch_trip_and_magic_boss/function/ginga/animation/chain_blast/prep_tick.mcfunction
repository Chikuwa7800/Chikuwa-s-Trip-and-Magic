...
#
 ...
 execute if score @s ch_tm_bosses_ginga_chain_blast matches 126.. if score @s ch_tm_bosses_action matches 411 run function ch_trip_and_magic_boss:ginga/animation/chain_blast/animation
