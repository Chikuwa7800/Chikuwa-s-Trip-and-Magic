##ギヌンガのティック処理
 #通常時の呼出台にパーティクル
  execute as @e[type=interaction,tag=ch_tm_bosses_ginunga_summon,tag=!ch_tm_bosses_ginunga_cannot_summon] at @s run particle end_rod ~ ~0.5 ~ 0.125 0.125 0.125 0.0125 1
 ...
 #呼出ティック処理
  execute as @e[type=interaction,tag=ch_tm_bosses_ginunga_summon_during_summon] at @s run function ch_trip_and_magic_boss:ginga/first/summon_tick
