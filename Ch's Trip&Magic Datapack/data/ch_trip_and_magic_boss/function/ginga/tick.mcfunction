##ギヌンガのティック処理
 #通常時の呼出台にパーティクル
  execute as @e[type=interaction,tag=ls_tm_bosses_ginunga_summon,tag=!ch_tm_bosses_ginunga_cannot_summon] at @s run particle end_rod ~ ~0.5 ~ 0.125 0.125 0.125 0.0125 1
