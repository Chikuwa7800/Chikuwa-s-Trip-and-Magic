...
execute if entity @s[scores={ch_tm_bosses_death_tick=1}] run advancement grant @a[tag=ch_tm.player.target.ginunga.ago] only ls_trip_and_magic:roots/boss/ginga
...
execute if entity @s[scores={ch_tm_bosses_death_tick=166..}] run tag @e[tag=ls_tm_bosses_ginunga_summon] remove ls_tm_bosses_ginunga_cannot_summon
