...
execute as @s[tag=ch_tm.boss.music.ginunga,tag=ch_tm.boss.music.ginunga.intro,scores={ch_tm_bosses_music_tick=4100..}] run function ch_trip_and_magic_boss:music/ginga/loop
execute as @s[tag=ch_tm.boss.music.ginunga,scores={ch_tm_bosses_music_tick=9415..}] run function ch_trip_and_magic_boss:music/ginga/loop
