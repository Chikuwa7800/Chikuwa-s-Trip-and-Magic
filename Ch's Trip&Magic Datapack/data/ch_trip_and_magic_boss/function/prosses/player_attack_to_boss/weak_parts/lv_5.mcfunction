...
scoreboard players set #ch_tm_bosses_add_damage ch_tm_bosses_dummy 150
...
playsound entity.player.attack.crit player @a ~ ~ ~ 1 0.5
execute at @n[tag=ch_trip_and_magic_bosses_hurted,tag=ch_trip_and_magic_bosses_intaract_weak_parts] run particle crit ~ ~ ~ 0.25 0.25 0.25 0.1 25