...
execute if entity @s[tag=ls_tm_used_glaive] positioned ^ ^ ^3 run tag @e[tag=!ls_tm_used_glaive,distance=..2,type=#ls_trip_and_magic:mobs_and_player_and_collision_entity] add ls_tm_hit_glaive
