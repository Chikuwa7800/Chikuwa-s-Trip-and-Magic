execute positioned ~-0.5 ~-0.5 ~-0.5 positioned ~-0.25 ~-0.25 ~-0.25 as @e[type=#ls_trip_and_magic:mobs_and_player_and_collision_entity,dx=0,tag=!ls_tm_used_spear] positioned ~0.5 ~0.5 ~0.5 run damage @s[dx=0] 1 player_attack by @p[tag=ls_tm_used_spear]
