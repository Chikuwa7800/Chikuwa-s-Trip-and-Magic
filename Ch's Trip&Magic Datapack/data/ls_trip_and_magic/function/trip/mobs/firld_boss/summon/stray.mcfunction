...
data merge entity @s[scores={ls_tm_random=50..59}] {drop_chances:{mainhand:0,offhand:0,head:0},DeathLootTable:"ls_trip_and_magic:entities/magic_stray"}
...
item modify entity @s[scores={ls_tm_random=50..59}] weapon.offhand ls_trip_and_magic:weapons/ice_spell_book
item modify entity @s[scores={ls_tm_random=50..59}] armor.head ls_trip_and_magic:ice_magic_hat
tag @s[scores={ls_tm_random=50..59}] add ls_tm_trip_mobs_magic_stray
...
item modify entity @s[scores={ls_tm_random=60..100}] weapon.mainhand ls_trip_and_magic:weapons/iron_knife
item modify entity @s[scores={ls_tm_random=60..100}] armor.head ls_trip_and_magic:melee_hat
data merge entity @s[scores={ls_tm_random=60..100}] {DeathLootTable:"ls_trip_and_magic:entities/melee_skeleton",drop_chances:{mainhand:0.05,head:0},attributes:[{id:"minecraft:attack_damage",base:-1}]}
