...
execute if entity @s[scores={ls_tm_random=50..59}] run function ls_trip_and_magic:trip/mobs/firld_boss/summon/init/magic_stray

execute if entity @s[scores={ls_tm_random=60..100}] run function ls_trip_and_magic:trip/mobs/firld_boss/summon/init/assassin_stray
