data merge entity @s {drop_chances:{mainhand:0,offhand:0,head:0},DeathLootTable:"ls_trip_and_magic:entities/magic_stray"}
...
item modify entity @s weapon.offhand ls_trip_and_magic:weapons/ice_spell_book
item modify entity @s armor.head ls_trip_and_magic:ice_magic_hat
tag @s add ls_tm_trip_mobs_magic_stray
