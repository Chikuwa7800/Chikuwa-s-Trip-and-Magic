#ダイブ
execute if predicate ls_trip_and_magic:score/used_stick unless predicate ls_trip_and_magic:acshident/sneaks if entity @s[tag=!ls_trip_and_magic_wakame_sword_jump_attack_,tag=!ls_trip_and_magic_wakame_sword_dive_cooldown] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] unless block ~ ~-2.6 ~ #ls_trip_and_magic:no_collision run function ls_trip_and_magic:magic/items/weapons/others/troll/wakame_sword/diving/start
#失敗
execute if predicate ls_trip_and_magic:score/used_stick unless predicate ls_trip_and_magic:acshident/sneaks if entity @s[tag=!ls_trip_and_magic_wakame_sword_jump_attack_,tag=ls_trip_and_magic_wakame_sword_dive_cooldown] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] unless block ~ ~-2.6 ~ #ls_trip_and_magic:no_collision run function ls_trip_and_magic:magic/cooldown {"name":"item_skill.wakame.1"}
...
#衝撃波
#失敗
execute if predicate ls_trip_and_magic:score/used_stick if predicate ls_trip_and_magic:acshident/sneaks if entity @s[tag=!ls_trip_and_magic_wakame_sword_jump_attack_,tag=ls_trip_and_magic_wakame_sword_boom_cooldown] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] run function ls_trip_and_magic:magic/cooldown {"name":"item_skill.wakame.2"}
execute if predicate ls_trip_and_magic:score/used_stick if predicate ls_trip_and_magic:acshident/sneaks if entity @s[tag=!ls_trip_and_magic_wakame_sword_jump_attack_,tag=ls_trip_and_magic_wakame_sword_boom_cooldown] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] run function ls_trip_and_magic:magic/items/weapons/wands/magic_staff/no
#成功
execute if predicate ls_trip_and_magic:score/used_stick if predicate ls_trip_and_magic:acshident/sneaks if entity @s[tag=!ls_trip_and_magic_wakame_sword_jump_attack_,tag=!ls_trip_and_magic_wakame_sword_boom_cooldown] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] run function ls_trip_and_magic:magic/items/weapons/others/troll/wakame_sword/boom/main

#ジャンプアタック
 execute if predicate ls_trip_and_magic:acshident/sneaks if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}},tag=!ls_trip_and_magic_wakame_sword_jump_attack_cooldown] run scoreboard players add @s ls_tm_shift 1
 #チャージ1
  execute if entity @s[scores={ls_tm_shift=10},tag=!ls_trip_and_magic_wakame_sword_jump_attack_one] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] run function ls_trip_and_magic:magic/items/weapons/others/troll/wakame_sword/jump_attack/one
 #チャージ完了
  execute if entity @s[scores={ls_tm_shift=30},tag=!ls_trip_and_magic_wakame_sword_jump_attack_] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{"datapack_type": "ls_trip_magic","item_type": "weapon","weapon_type": "wakame_sword",item_condition:"red"}}}}] run function ls_trip_and_magic:magic/items/weapons/others/troll/wakame_sword/jump_attack/rast
 #待機
