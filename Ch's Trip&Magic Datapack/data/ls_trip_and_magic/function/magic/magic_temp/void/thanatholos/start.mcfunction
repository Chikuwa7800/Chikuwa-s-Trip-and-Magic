...
execute positioned ^ ^ ^1.5 positioned ~-3 ~ ~-3 as @e[tag=!ls_tm_thantholos_pl,dx=3,dz=3,type=!#ls_trip_and_magic:cannot_hurt_entities] at @s run damage @s 6 ls_trip_and_magic:add_damage by @p[tag=ls_tm_thantholos_pl]
