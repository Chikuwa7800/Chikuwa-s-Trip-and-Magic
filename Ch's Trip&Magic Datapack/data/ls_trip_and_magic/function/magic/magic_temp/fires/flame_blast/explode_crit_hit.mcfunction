...
execute positioned ~-3 ~-3 ~-3 as @e[dx=5,dy=5,dz=5,tag=!ch_tm_fb_attacker,type=!#ls_trip_and_magic:cannot_hurt_entities,tag=!ls_tm_blast_ball_display] positioned ~3 ~3 ~3 if entity @s[tag=!ls_tm_using_shield] run function ls_trip_and_magic:magic/effect/flame/start {"time":"4"}
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!ch_tm_fb_attacker,type=!#ls_trip_and_magic:cannot_hurt_entities,tag=!ls_tm_blast_ball_display] positioned ~0.5 ~0.5 ~0.5 run damage @s 15 ls_trip_and_magic:magic/fire_lv2_hit by @n[tag=ls_tm_blast_ball_display] from @n[tag=ch_tm_fb_attacker]
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!ch_tm_fb_attacker,type=!#ls_trip_and_magic:cannot_hurt_entities,tag=!ls_tm_blast_ball_display] positioned ~0.5 ~0.5 ~0.5 if entity @s[tag=!ls_tm_using_shield] run function ls_trip_and_magic:magic/effect/flame/start {"time":"8"}
