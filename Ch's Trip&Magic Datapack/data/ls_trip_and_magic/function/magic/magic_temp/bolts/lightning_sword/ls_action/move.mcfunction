...
execute positioned ~-5.5 ~-5.5 ~-5.5 as @e[type=!#ls_trip_and_magic:cannot_hurt_entities,dx=10,dy=10,dz=10] positioned ~5.5 ~5.5 ~5.5 run function ls_trip_and_magic:magic/magic_temp/bolts/lightning_sword/ls_action/near