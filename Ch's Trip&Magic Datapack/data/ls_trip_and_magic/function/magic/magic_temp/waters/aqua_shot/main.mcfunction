...
particle dust{color:[0.118,0.153,0.635],scale:2} ^ ^ ^-0.5 0.1 0.1 0.1 0.2 10 force

execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[dx=0,tag=!ls_tm_magic_pl,type=!#ls_trip_and_magic:mobs,tag=!ls_tm_waterball_display] positioned ~0.5 ~0.5 ~0.5 run function ls_trip_and_magic:magic/magic_temp/waters/aqua_shot/water
