...
execute as @n[tag=ch_tm_gust_burster,tag=!ch_tm_motion_applyed] at @s rotated as @n[tag=ch_tm_gust_pl] run function ls_trip_and_magic:magic/magic_temp/nature/gust_burst/gust_motion