...
execute rotated ~ 0 positioned ^ ^ ^3 run particle dust_pillar{block_state:dirt} ~ ~ ~ 3 0 3 1 500
execute rotated ~ 0 positioned ^ ^ ^3 positioned ~-3 ~-1 ~-3 as @e[dx=6,dy=2,dz=6,type=!#ls_trip_and_magic:cannot_hurt_entities,tag=!ls_tm_magic_pl] run damage @s 5 ls_trip_and_magic:magic/nature_lv2 by @p[tag=ls_tm_magic_pl]
