...
execute if entity @s[type=!#ls_trip_and_magic:one_blocks,type=!slime] run particle entity_effect{color:-16757068} ~ ~0.5 ~ 0.25 0.5 0.25 0. 1
execute if entity @s[type=#ls_trip_and_magic:one_blocks] run particle entity_effect{color:-16757068} ~ ~0.5 ~ 0.25 0.25 0.25 0. 1
execute if entity @s[type=slime] run particle entity_effect{color:-16757068} ~ ~0.5 ~ 0.5 0.5 0.5 0. 1
