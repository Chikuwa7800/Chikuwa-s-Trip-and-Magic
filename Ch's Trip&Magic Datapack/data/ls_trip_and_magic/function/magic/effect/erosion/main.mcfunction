...
execute if entity @s[type=!#ls_trip_and_magic:one_blocks,type=!slime] run particle entity_effect{color:-9138941} ~ ~1.25 ~ 0.25 0.5 0.25 0. 10
execute if entity @s[type=#ls_trip_and_magic:one_blocks] run particle entity_effect{color:-9138941} ~ ~1.25 ~ 0.25 0.25 0.25 0. 10
execute if entity @s[type=slime] run particle entity_effect{color:-9138941} ~ ~1.25 ~ 0.5 0.5 0.5 0. 10
  #ダメージ
