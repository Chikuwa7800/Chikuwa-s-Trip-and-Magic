## flame
 ...
 #タイマーを減少させる
  ...
  execute if entity @s[type=!#ls_trip_and_magic:one_blocks,type=!slime] run particle dust{color:[1.000,0.467,0.059],scale:0.5} ~ ~0.5 ~ 0.25 0.5 0.25 0. 10
  execute if entity @s[type=#ls_trip_and_magic:one_blocks] run particle dust{color:[1.000,0.467,0.059],scale:0.5} ~ ~0.5 ~ 0.25 0.25 0.25 0. 10
