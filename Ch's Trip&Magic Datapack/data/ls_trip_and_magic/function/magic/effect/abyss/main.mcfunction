## abyss
 ...
 #タイマーを減少させる
  ...
  #ダメージ
   execute if entity @s[scores={ls_tm_magic_abyss_tick=1..,ls_tm_magic_abyss_tick_dummy=10..,ls_trip_magic_health=6..}] run function ls_trip_and_magic:magic/effect/abyss/damage
   #ダメージ(最後のやつ)
   ...
   execute if entity @s[scores={ls_trip_magic_health=..5,ls_tm_magic_abyss_tick_dummy=10..}] run function ls_trip_and_magic:magic/effect/abyss/last
 #ダミータイマーリセット
