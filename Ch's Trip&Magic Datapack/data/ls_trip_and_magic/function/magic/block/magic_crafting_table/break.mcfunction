...
execute if entity @p[gamemode=!creative,gamemode=!spectator] as @n[tag=ch_tm_magic_crafting_table_core] at @s run loot spawn ~ ~0.25 ~ loot ls_trip_and_magic:item/magic/magic_crafting_table
...
execute as @n[tag=ch_tm_magic_crafting_table_core] at @s as @e[tag=ch_tm_magic_crafting_table_item_display,distance=..1.25] at @s unless entity @e[tag=ch_tm_magic_crafting_table_select,distance=..0.75] run function ls_trip_and_magic:magic/block/magic_crafting_table/display_break
execute as @n[tag=ch_tm_magic_crafting_table_core] at @s run kill @s
advancement revoke @s only ls_trip_and_magic:magic/magic_table_break
