...
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ls_trip_and_magic:item/weapons/magic/book/water
...
tag @s[scores={ls_tm_magic_crafting_table_craft_tick=101}] remove ls_tm_magic_crafting_table_crafting_magic_book_water
