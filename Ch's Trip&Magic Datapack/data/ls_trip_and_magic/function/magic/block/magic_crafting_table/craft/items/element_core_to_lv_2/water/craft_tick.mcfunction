...
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80}] run playsound trip_magic:block.magic_crafting_table.water block @a ~ ~ ~
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:rain ~ ~0.5 ~ 0.25 0.25 0.25 0. 25
...
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:splash ~ ~0.25 ~ 0.25 0.25 0.25 0. 10
...
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80..85}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:underwater ~ ~0.25 ~ 0.5 0.5 0.5 0 10
execute if entity @s[scores={ls_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ls_trip_and_magic:item/weapons/magic/book/lv_2/water
...
tag @s[scores={ls_tm_magic_crafting_table_craft_tick=101}] remove ls_tm_magic_crafting_table_crafting_magic_book_water_lv2
