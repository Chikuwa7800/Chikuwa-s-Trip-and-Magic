...
scoreboard players operation @s ls_tm_magic_mana_max_xp = @s ch_tm_magic_xp_level_dummy
...
scoreboard players operation @s ls_tm_magic_mana_up_xp = @s ch_tm_magic_xp_level_dummy
