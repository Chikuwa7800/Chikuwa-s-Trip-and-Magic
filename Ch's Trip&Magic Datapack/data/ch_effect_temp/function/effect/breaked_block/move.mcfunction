...
execute positioned ~-0.5 ~-0.5 ~-0.5 unless block ^ ^ ^0.5 #ls_trip_and_magic:no_collision run function ch_effect_temp:effect/breaked_block/break
execute if entity @e[dx=1,dy=1,dz=1,type=#ls_trip_and_magic:mobs_and_player_and_collision_entity] run function ch_effect_temp:effect/breaked_block/break
