...
execute if entity @s[scores={ch_tm_random=0..79}] run return fail

execute if entity @s[scores={ch_tm_random=80..100}] run function ch_trip_and_magic:trip/mobs/firld_boss/summon/init/magic_parched
