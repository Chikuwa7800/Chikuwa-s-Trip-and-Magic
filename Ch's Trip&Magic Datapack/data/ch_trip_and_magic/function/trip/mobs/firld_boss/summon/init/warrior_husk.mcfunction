...
item modify entity @s armor.head ch_trip_and_magic:warrior_helm
item modify entity @s weapon.offhand ch_trip_and_magic:bash_shield
tag @s add ch_tm_trip_mobs_warrior_husk
