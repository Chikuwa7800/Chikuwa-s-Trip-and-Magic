...
item modify entity @s weapon.mainhand ch_trip_and_magic:weapons/iron_knife
item modify entity @s armor.head ch_trip_and_magic:melee_hat
data merge entity @s {DeathLootTable:"ch_trip_and_magic:entities/melee_skeleton",drop_chances:{mainhand:0.05,head:0},attributes:[{id:"minecraft:attack_damage",base:-1}]}
