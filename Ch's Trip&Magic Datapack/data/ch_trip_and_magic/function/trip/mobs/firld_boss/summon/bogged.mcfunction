...
execute if entity @s[scores={ch_tm_random=50..59}] run function ch_trip_and_magic:trip/mobs/firld_boss/summon/init/magic_bogged

execute if entity @s[scores={ch_tm_random=60..100}] run function ch_trip_and_magic:trip/mobs/firld_boss/summon/init/glaivemaster_bogged