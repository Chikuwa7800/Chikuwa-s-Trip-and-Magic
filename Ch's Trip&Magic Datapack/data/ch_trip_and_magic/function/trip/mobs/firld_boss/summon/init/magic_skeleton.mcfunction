data merge entity @s {drop_chances:{mainhand:0,offhand:0,head:0},DeathLootTable:"ch_trip_and_magic:entities/magic_skeleton"}
...
item modify entity @s weapon.offhand ch_trip_and_magic:weapons/nature_spell_book
item modify entity @s armor.head ch_trip_and_magic:nature_magic_hat
tag @s add ch_tm_trip_mobs_magic_skeleton
