...
execute if entity @e[distance=..50,predicate=ch_trip_and_magic:trip/mobs/target,tag=!ch_tm_trip_mobs_craive_illager_using_skill] run scoreboard players add @s ch_trip_boss_tick 1
...
execute if score @s ch_trip_boss_tick matches 30 store result score @s ch_trip_boss_random run random value 0..100
execute if score @s ch_trip_boss_tick matches 30 if score @s ch_trip_boss_random matches 85.. run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill

execute if score @s ch_trip_boss_tick matches 40 store result score @s ch_trip_boss_random run random value 0..100
execute if score @s ch_trip_boss_tick matches 40 if score @s ch_trip_boss_random matches 75.. run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill

execute if score @s ch_trip_boss_tick matches 50 store result score @s ch_trip_boss_random run random value 0..100
execute if score @s ch_trip_boss_tick matches 50 if score @s ch_trip_boss_random matches 50.. run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill

execute if score @s ch_trip_boss_tick matches 60.. run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill