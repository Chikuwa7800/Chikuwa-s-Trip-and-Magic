...
execute on target if entity @s[distance=..2] as @n[tag=ch_tm_trip_mobs_craive_illager_vs_mellee] facing entity @n[tag=ch_tm_craiver_target] eyes positioned ^ ^ ^-11 if block ~ ~ ~ #ch_trip_and_magic:no_collision_exclude_water unless block ~ ~-1 ~ #ch_trip_and_magic:mobs_dislike unless block ~ ~-2 ~ #ch_trip_and_magic:mobs_dislike unless block ~ ~-3 ~ #ch_trip_and_magic:mobs_dislike run return run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill/glaive/vs_mellee/backward_step/jump/apply
execute on target if entity @s[distance=5..] as @n[tag=ch_tm_trip_mobs_craive_illager_vs_mellee] facing entity @n[tag=ch_tm_craiver_target] eyes positioned ^ ^ ^-7 if block ~ ~ ~ #ch_trip_and_magic:no_collision_exclude_water unless block ~ ~-1 ~ #ch_trip_and_magic:mobs_dislike unless block ~ ~-2 ~ #ch_trip_and_magic:mobs_dislike unless block ~ ~-3 ~ #ch_trip_and_magic:mobs_dislike run return run function ch_trip_and_magic:trip/mobs/firld_boss/main/illager/craiver/skill/glaive/vs_mellee/backward_step/normal/apply
