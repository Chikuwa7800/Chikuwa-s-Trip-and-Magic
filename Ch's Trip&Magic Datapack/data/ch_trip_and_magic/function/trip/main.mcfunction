function ch_trip_and_magic:trip/appdata/main

function ch_trip_and_magic:trip/mobs/main

#function ch_trip_and_magic:trip/items/bule_bull/tick

#execute as @a[tag=ch_tm_look_pl] at @s if entity @e[distance=..8] run function ch_trip_and_magic:trip/weapons/spear/main

#execute as @a at @s anchored eyes run function ch_trip_and_magic:trip/weapons/look

#execute if entity @e[tag=ch_tm_look_pl] run playsound ui.button.click player @a ~ ~ ~ 1 1 1
#execute as @e[tag=ch_tm_look_pl] at @s run particle crit ~ ~ ~ 0 0 0 0.2 20
...
scoreboard players remove @a ch_tm_craive_cooldown 1
execute as @a[predicate=ch_trip_and_magic:trip/claive/inventory] at @s run function ch_trip_and_magic:trip/items/claive/craive_main
