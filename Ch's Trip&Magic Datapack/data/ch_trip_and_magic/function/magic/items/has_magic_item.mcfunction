...
execute if predicate ch_trip_and_magic:magic/spell_book/_has if predicate ch_trip_and_magic:acshident/sneaks if score @s ch_tm_magic_casting matches 0 run function ch_trip_and_magic:magic/items/weapons/wands/magic_staff/_charge/main
