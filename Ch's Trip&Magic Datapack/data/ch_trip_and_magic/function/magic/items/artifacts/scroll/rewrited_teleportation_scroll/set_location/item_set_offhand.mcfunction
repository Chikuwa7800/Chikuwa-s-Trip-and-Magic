...
execute positioned ~ ~1002 ~ run item replace entity @n[type=item_display] contents from entity @s weapon.offhand
execute positioned ~ ~1002 ~ as @n[type=item_display] run function ch_trip_and_magic:magic/items/artifacts/scroll/rewrited_teleportation_scroll/set_location/set_pos_offhand
