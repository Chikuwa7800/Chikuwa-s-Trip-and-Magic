...
clear @s[tag=ch_tm_has_teleport_location,gamemode=!creative,gamemode=!spectator] warped_fungus_on_a_stick[minecraft:custom_data={"item_type": "equipment","equipment_type": "scroll","item_condition": "teleportation_scroll","item_magic": "true"}] 1
