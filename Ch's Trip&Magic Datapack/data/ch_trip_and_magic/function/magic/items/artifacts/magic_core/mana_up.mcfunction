...
clear @s[gamemode=!creative,gamemode=!spectator] warped_fungus_on_a_stick[custom_data={"item_type": "equipment","equipment_type": "magic_core","item_condition": "mana_max_up","item_magic": "true"}] 1