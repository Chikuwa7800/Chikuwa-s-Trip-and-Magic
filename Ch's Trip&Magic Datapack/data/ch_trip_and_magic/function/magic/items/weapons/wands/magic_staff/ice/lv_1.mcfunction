execute if entity @s[tag=ch_tm_magic_frost_cooldown] run function ch_trip_and_magic:magic/cooldown {"name":"item_skill.magic.ice.lv1","cooltime":"0.5"}
...
execute if entity @s[scores={ch_tm_magic_mana=..4}] run tellraw @s [{"translate":"notice.notenough_mana","color":"dark_red","bold":true,"italic":false,"underlined":true},{"text":" ","bold":false,"italic":false,"underlined":false},{"translate":"notice.required","color":"dark_red","bold":false,"italic":false,"underlined":false},{"text":"5","color":"dark_red","bold":false,"italic":false,"underlined":false}]
