...
execute if entity @s[scores={ch_tm_magic_mana=..7}] run tellraw @s [{"translate":"notice.notenough_mana","color":"dark_red","italic":false},{"text":" ","bold":false,"italic":false,"underlined":false},{"translate":"notice.required","color":"dark_red","bold":false,"italic":false,"underlined":false},{"text":"8","color":"dark_red","bold":false,"italic":false,"underlined":false}]
