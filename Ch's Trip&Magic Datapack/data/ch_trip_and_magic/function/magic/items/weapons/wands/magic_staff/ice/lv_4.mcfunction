execute if entity @s[tag=ch_tm_magic_cryo_cooldown] run function ch_trip_and_magic:magic/cooldown {"name":"item_skill.magic.ice.lv4","cooltime":"25"}
execute if entity @s[tag=ch_tm_magic_cryo_cooldown] run function ch_trip_and_magic:magic/items/weapons/wands/magic_staff/no
execute if entity @s[tag=ch_tm_magic_cryo_cooldown] run return fail
execute if entity @s[scores={ch_tm_magic_mana=32..}] run function ch_trip_and_magic:magic/magic_temp/ices/cryo_stasis/start
execute if entity @s[scores={ch_tm_magic_mana=32..}] run tag @s add ch_tm_magic_cryo_cooldown
