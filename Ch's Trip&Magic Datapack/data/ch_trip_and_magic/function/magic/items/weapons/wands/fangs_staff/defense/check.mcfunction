...
execute if entity @s[scores={ch_tm_magic_mana=..11}] run execute if entity @s[scores={ch_tm_magic_mana=..9}] run tellraw @s {"translate":"notice.notenough_mana","color":"dark_red","italic":false}
