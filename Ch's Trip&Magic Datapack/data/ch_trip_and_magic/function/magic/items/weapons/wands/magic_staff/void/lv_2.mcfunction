execute if entity @s[tag=ch_tm_than_cooldown] run function ch_trip_and_magic:magic/cooldown {"name":"item_skill.magic.void.lv2"}
...
execute if entity @s[scores={ch_tm_magic_mana=10..}] run function ch_trip_and_magic:magic/magic_temp/void/thanatholos/start
execute if entity @s[scores={ch_tm_magic_mana=10..}] run tag @s add ch_tm_than_cooldown
