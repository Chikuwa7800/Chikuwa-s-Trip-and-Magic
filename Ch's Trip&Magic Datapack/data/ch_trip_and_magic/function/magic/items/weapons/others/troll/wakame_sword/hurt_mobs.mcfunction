#scoreboard players add @s ch_tm_wakame_player_hurt_mobs 1
advancement revoke @s only ch_trip_and_magic:trip/weapons/attack/wakame_sword
execute unless entity @s[predicate=ch_trip_and_magic:magic/wakame/mainhand,predicate=ch_trip_and_magic:magic/wakame/normal] run return fail
