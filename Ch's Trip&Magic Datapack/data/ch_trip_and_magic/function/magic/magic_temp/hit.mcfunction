execute positioned ~1 ~1 ~1 as @e[dx=2,type=#ch_trip_and_magic:mirror] positioned ~-1 ~-1 ~-1 run damage @s 5 ch_trip_and_magic:magic/nature_lv1 by @a[limit=1,sort=nearest]
execute positioned ~1 ~1 ~1 as @e[dx=2,type=#ch_trip_and_magic:kills] positioned ~-1 ~-1 ~-1 run kill @s
execute positioned ~1 ~1 ~1 as @e[dx=2,type=#ch_trip_and_magic:kills] positioned ~-1 ~-1 ~-1 run playsound entity.item.break block @a ~ ~ ~ 2 1

tag @e[dx=2,type=#ch_trip_and_magic:mirror] add ls_mirror_mosion
