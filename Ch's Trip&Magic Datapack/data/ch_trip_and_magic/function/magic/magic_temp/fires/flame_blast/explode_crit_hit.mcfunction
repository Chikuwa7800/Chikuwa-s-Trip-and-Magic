...
playsound entity.generic.explode player @a ~ ~ ~ 4 0.5
...
execute positioned ~-3 ~-3 ~-3 as @e[dx=5,dy=5,dz=5,tag=!ch_tm_fb_attacker,type=!#ch_trip_and_magic:cannot_hurt_entities,tag=!ch_tm_blast_ball_display] positioned ~3 ~3 ~3 run damage @s 8 ch_trip_and_magic:magic/fire_lv3 by @n[tag=ch_tm_blast_ball_display] from @n[tag=ch_tm_fb_attacker]
...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!ch_tm_fb_attacker,type=!#ch_trip_and_magic:cannot_hurt_entities,tag=!ch_tm_blast_ball_display] positioned ~0.5 ~0.5 ~0.5 run damage @s 15 ch_trip_and_magic:magic/fire_lv3_hit by @n[tag=ch_tm_blast_ball_display] from @n[tag=ch_tm_fb_attacker]
