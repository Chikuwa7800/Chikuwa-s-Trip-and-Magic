execute store result score @s ch_tm_entity_id run scoreboard players get @n[tag=ch_magic_lightning_sword_pl] ch_tm_entity_id
execute store result entity @s data."owner" int 1 run scoreboard players get @n[tag=ch_magic_lightning_sword_pl] ch_tm_entity_id
