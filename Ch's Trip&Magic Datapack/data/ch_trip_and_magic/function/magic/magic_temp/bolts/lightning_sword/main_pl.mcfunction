...
execute if score @s ch_tm_magic_lightsword_tick matches 1..38 run function ch_trip_and_magic:magic/magic_temp/bolts/lightning_sword/rotate with entity @n[type=marker,tag=ch_tm_magic_lightning_sword_entity_id] data
