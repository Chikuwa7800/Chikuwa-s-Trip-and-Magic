...
execute positioned ~-3.5 ~-3.5 ~-3.5 as @e[type=!#ch_trip_and_magic:cannot_hurt_entities,dx=6,dy=6,dz=6,tag=!ch_tm_ls_attacker] positioned ~3.5 ~3.5 ~3.5 run damage @s 10 ch_trip_and_magic:magic/bolts_lv4 by @n[tag=ch_tm_magic_lightning_sword_hit] from @n[tag=ch_tm_ls_attacker]
