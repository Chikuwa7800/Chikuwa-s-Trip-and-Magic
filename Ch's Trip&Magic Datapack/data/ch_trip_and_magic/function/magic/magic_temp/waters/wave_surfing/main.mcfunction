...
scoreboard players remove @s ch_tm_wave_surfing_tick 1
execute if score @s ch_tm_wave_surfing_tick matches ..0 run function ch_trip_and_magic:magic/magic_temp/waters/wave_surfing/reset
