...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!ch_tm_vos_attacker,type=!#ch_trip_and_magic:cannot_hurt_entities,tag=!ch_tm_void_ball] positioned ~0.5 ~0.5 ~0.5 run damage @s 15 ch_trip_and_magic:magic/void_lv3_hit by @n[tag=ch_tm_void_ball] from @n[tag=ch_tm_vos_attacker]
