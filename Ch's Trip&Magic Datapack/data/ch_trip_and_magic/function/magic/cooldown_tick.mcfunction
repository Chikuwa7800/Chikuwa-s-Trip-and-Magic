...
execute as @a[tag=ch_tm_magic_flare_cooldown] at @s run function ch_trip_and_magic:magic/cooldown/flare

execute as @a[tag=ch_tm_magic_blast_cooldown] at @s run function ch_trip_and_magic:magic/cooldown/blast

execute as @a[tag=ch_tm_magic_pyro_cooldown] at @s run function ch_trip_and_magic:magic/cooldown/pyro

execute as @a[tag=ch_tm_magic_frost_cooldown] at @s run function ch_trip_and_magic:magic/cooldown/frost
