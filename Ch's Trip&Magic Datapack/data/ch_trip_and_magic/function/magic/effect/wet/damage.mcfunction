execute if entity @s[type=!#ch_trip_and_magic:one_blocks,type=!slime] run particle dust{color:[0.020,0.051,1.000],scale:2} ~ ~0.5 ~ 0.25 0.5 0.25 0. 5
execute if entity @s[type=!#ch_trip_and_magic:one_blocks,type=!slime] run particle splash ~ ~0.5 ~ 0.25 0.5 0.25 0. 5

execute if entity @s[type=#ch_trip_and_magic:one_blocks] run particle dust{color:[0.020,0.051,1.000],scale:2} ~ ~0.5 ~ 0.25 0.25 0.25 0. 5
execute if entity @s[type=#ch_trip_and_magic:one_blocks] run particle splash ~ ~0.5 ~ 0.25 0.25 0.25 0. 5
