## abyss
 ...
 #タイマーを減少させる
  ...
  #ダメージ
   execute if entity @s[scores={ch_tm_magic_abyss_tick=1..,ch_tm_magic_abyss_tick_dummy=10..,ch_trip_magic_health=4..}] run function ch_trip_and_magic:magic/effect/abyss/damage
   #ダメージ(最後のやつ)
   ...
   execute if entity @s[scores={ch_trip_magic_health=..4,ch_tm_magic_abyss_tick_dummy=10..}] run function ch_trip_and_magic:magic/effect/abyss/last
 #ダミータイマーリセット
