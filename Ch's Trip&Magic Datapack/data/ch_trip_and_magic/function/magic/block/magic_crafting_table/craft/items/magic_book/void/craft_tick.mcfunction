...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run playsound trip_magic:block.magic_crafting_table.void block @a ~ ~ ~
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:sonic_boom ~ ~0.25 ~ 0.0 0.0 0.0 0. 1
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:flash{color:-12255123}
...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:sculk_soul ~ ~0.25 ~ 0.25 0.25 0.25 0. 5
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:soul ~ ~0.25 ~ 0.25 0.25 0.25 0. 5
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..85}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:dust{color:[0.161,0.055,0.188],scale:1} ~ ~0.25 ~ 0.25 0.25 0.25 0 5
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..85}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:dust{color:[0.322,0.11,0.373],scale:2} ~ ~0.25 ~ 0.25 0.25 0.25 0 5
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ch_trip_and_magic:item/weapons/magic/book/void
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run kill @n[tag=ch_tm_magic_crafting_table_core_item_display_magic_book]
...
tag @s[scores={ch_tm_magic_crafting_table_craft_tick=101}] remove ch_tm_magic_crafting_table_crafting_magic_book_void
