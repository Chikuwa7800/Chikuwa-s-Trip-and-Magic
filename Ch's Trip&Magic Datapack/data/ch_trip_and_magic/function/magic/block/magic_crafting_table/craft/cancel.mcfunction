...
execute as @e[tag=ch_tm_magic_crafting_table_item_display,distance=..1] at @s run function ch_trip_and_magic:magic/block/magic_crafting_table/display_break
