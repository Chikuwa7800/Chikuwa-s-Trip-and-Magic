...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run playsound trip_magic:block.magic_crafting_table.wakame block @a ~ ~ ~
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:splash ~ ~0.25 ~ 0.25 0.25 0.25 0. 25
...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:underwater ~ ~0.25 ~ 0.25 0.25 0.25 0. 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:spore_blossom_air ~ ~0.25 ~ 0.0 0.0 0.0 0 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ch_trip_and_magic:item/weapons/magic/wakame_sword
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run kill @e[tag=ch_tm_magic_crafting_table_core_item_display_wakame,limit=5,sort=nearest]
...
tag @s[scores={ch_tm_magic_crafting_table_craft_tick=101}] remove ch_tm_magic_crafting_table_crafting_wakame_sword
