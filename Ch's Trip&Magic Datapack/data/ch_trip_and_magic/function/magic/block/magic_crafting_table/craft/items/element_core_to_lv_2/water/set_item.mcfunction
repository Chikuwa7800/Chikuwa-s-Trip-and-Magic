clear @p[predicate=ch_trip_and_magic:magic/craft/material/spell_book/water,predicate=ch_trip_and_magic:magic/craft/material/spell_book/_base,predicate=ch_trip_and_magic:magic/craft/material/spell_book/lv1/_base,gamemode=!creative,gamemode=!spectator] warped_fungus_on_a_stick[custom_data={"item_condition": "water","weapon_type": "magic_book","spell_level":["1"]}] 1
