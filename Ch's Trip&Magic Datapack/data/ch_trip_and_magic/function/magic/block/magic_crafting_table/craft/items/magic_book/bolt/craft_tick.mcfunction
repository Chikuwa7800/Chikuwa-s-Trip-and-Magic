...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run playsound trip_magic:block.magic_crafting_table.bolt block @a ~ ~ ~
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:electric_spark ~ ~0.25 ~ 0.25 0.25 0.25 0. 25
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:flash{color:-6647}
...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:wax_on ~ ~0.25 ~ 0.25 0.25 0.25 0.2 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..85}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:end_rod ~ ~0.25 ~ 0.0 0.0 0.0 0.25 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ch_trip_and_magic:item/weapons/magic/book/bolt
...
tag @s[scores={ch_tm_magic_crafting_table_craft_tick=101}] remove ch_tm_magic_crafting_table_crafting_magic_book_bolt
