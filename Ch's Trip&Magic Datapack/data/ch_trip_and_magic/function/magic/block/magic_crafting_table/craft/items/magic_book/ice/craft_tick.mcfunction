...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] run playsound trip_magic:block.magic_crafting_table.ice block @a ~ ~ ~
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:snowflake ~ ~0.25 ~ 0.25 0.25 0.25 0. 25
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:flash{color:-8519681}
...
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..100}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:block{block_state:ice} ~ ~0.25 ~ 0.25 0.25 0.25 0. 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80..85}] as @n[tag=aj.global.node.crafted] at @s run particle minecraft:dust{color:[0.863,0.969,0.973],scale:1} ~ ~0.25 ~ 0.25 0.25 0.25 0 10
execute if entity @s[scores={ch_tm_magic_crafting_table_craft_tick=80}] at @n[tag=aj.global.node.crafted] run loot spawn ~ ~ ~ loot ch_trip_and_magic:item/weapons/magic/book/ice
...
tag @s[scores={ch_tm_magic_crafting_table_craft_tick=101}] remove ch_tm_magic_crafting_table_crafting_magic_book_ice
