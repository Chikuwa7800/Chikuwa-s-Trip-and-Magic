# core
 scoreboard objectives add ch_tm_using_sticks used:warped_fungus_on_a_stick
 scoreboard objectives add ch_tm_tick dummy
...
# magic
 scoreboard objectives add ch_tm_magic_mana dummy
 scoreboard objectives add ch_tm_magic_mana_max dummy
 scoreboard objectives add ch_tm_magic_mana_add dummy
 scoreboard objectives add ch_tm_magic_fleeze dummy
 scoreboard objectives add ch_tm_magic_fleeze_cooldown dummy
 scoreboard objectives add ch_tm_magic_blast_cooldown dummy
 scoreboard objectives add ch_tm_magic_volt_cooldown dummy
 scoreboard objectives add ch_tm_magic_screen_cooldown dummy
 scoreboard objectives add ch_tm_fangs_attack_cooldown dummy
 scoreboard objectives add ch_tm_magic_flare_cooldown dummy
 scoreboard objectives add ch_tm_magic_frost_cooldown dummy
 scoreboard objectives add ch_tm_magic_zephyr_cooldown dummy
 scoreboard objectives add ch_tm_magic_atte_cooldown dummy
 scoreboard objectives add ch_tm_magic_abyss_cooldown dummy
 scoreboard objectives add ch_tm_magic_than_cooldown dummy
 scoreboard objectives add ch_tm_magic_aqua_cooldown dummy
 scoreboard objectives add ch_tm_magic_surfing_cooldown dummy
 scoreboard objectives add ch_tm_magic_lightsword_cooldown dummy
 scoreboard objectives add ch_tm_magic_lightsword_tick dummy
 scoreboard objectives add ch_tm_magic_lightsword_tick_hit dummy
 scoreboard objectives add ch_tm_magic_pl_tick dummy
 scoreboard objectives add ch_tm_magic_abyss_tick dummy
 scoreboard objectives add ch_tm_magic_abyss_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_abyss_time_decide dummy
 scoreboard objectives add ch_tm_wakame_player_hurt_mobs dummy
 scoreboard objectives add ch_tm_wakame_angry_time_limit dummy
 scoreboard objectives add ch_tm_wakame_angry_time_limit_seconds dummy
 scoreboard objectives add ch_tm_magic_mana_up dummy
 scoreboard objectives add ch_tm_wakame_red_rush dummy
 scoreboard objectives add ch_tm_fangs_staff_attack dummy
 scoreboard objectives add ch_tm_magic_dive_cooldown dummy
 scoreboard objectives add ch_tm_magic_boom_cooldown dummy
 scoreboard objectives add ch_tm_magic_jump_attack_cooldown dummy
 scoreboard objectives add ch_tm_wakame_jump dummy
 #scoreboard objectives add ch_tm_wakame_red_wakamequake dummy
 #scoreboard objectives add ch_tm_magic_wakame_quake dummy
 scoreboard objectives add ch_tm_magic_crafting_table_craft_tick dummy
 scoreboard objectives add ch_tm_magic_cut_tick dummy
 scoreboard objectives add ch_tm_magic_cut_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_flame_tick dummy
 scoreboard objectives add ch_tm_magic_flame_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_frost_tick dummy
 scoreboard objectives add ch_tm_magic_frost_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_erosion_tick dummy
 scoreboard objectives add ch_tm_magic_erosion_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_wet_tick dummy
 scoreboard objectives add ch_tm_magic_wet_tick_dummy dummy
 scoreboard objectives add ch_tm_magic_electro_tick dummy
 scoreboard objectives add ch_tm_magic_electro_tick_dummy dummy
 scoreboard objectives add ch_tm_thantholos_tick dummy
 scoreboard objectives add ch_tm_wave_surfing_tick dummy
 scoreboard objectives add ch_tm_spell_charge dummy
 scoreboard objectives add ch_tm_magic_gust_cooldown dummy
 scoreboard objectives add ch_tm_magic_gust_tick dummy
 scoreboard objectives add ch_tm_magic_mana_max_xp dummy
 scoreboard objectives add ch_tm_magic_mana_up_xp dummy
 ...
 #scoreboard objectives add ch_tm_used_teleportation_scroll trigger
 scoreboard objectives add ch_tm_teleportation_scroll_tick dummy
 scoreboard objectives add ch_tm_teleportation_scroll_sec dummy
 scoreboard objectives add ch_tm_re_teleportation_scroll_tick dummy
 scoreboard objectives add ch_tm_re_teleportation_scroll_sec dummy
 scoreboard objectives add ch_tm_re_teleportation_scroll_sec_pos_saver dummy
 ...
 scoreboard objectives add ch_tm_magic_lightning_rapier_charge_reduce_mana dummy
...
# trip
 ...
 scoreboard objectives add ch_tm_craive_damage dummy
 scoreboard objectives add ch_trip_boss_random dummy
...
function ch_trip_and_magic:score

# 没だ！！コイツラは！！！
 #scoreboard objectives add ch_tm_blue_bull dummy
 #scoreboard objectives add ch_tm_blue_bull_drink dummy
 #scoreboard objectives add ch_tm_blue_bull_drink_effects dummy
 #scoreboard objectives add ch_tm_blue_bull_drink_shift dummy